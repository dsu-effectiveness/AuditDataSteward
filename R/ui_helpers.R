...
#' @param file represents the file used to perform the audits i.e student, course, student_course, graduation, etc...
#' @importFrom dplyr select any_of rename
#' @export
format_error_table <- function(error_table, value_table, rule = NULL,
                               file = c("student", "course", "student_course", "graduation", "building", "room")) {
  file <- match.arg(file)
  rule_in <- rule
